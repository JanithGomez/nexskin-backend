...
//      * - Fulfillment (Processing → Add Tracking → Shipped → (COD Paid) → Delivered / Delivery Failed)
//      *
//      * Notes:
//      * - Optional note + checkbox "Send this note to customer?"
//      * - COD rules:
//      *   - Mark Paid (COD) visible when payment_status = pending OR failed
//      *   - Delivered visible only when payment_status = paid
//      *   - Delivery Failed will auto-mark payment failed (handled inside OrderEventService::deliveryFailed)
//      * - Non-COD rules:
//      *   - No "Mark Paid" step
//      *   - Shipped → Delivered / Delivery Failed
//      */
...
//                 // 1) Mark Processing (only when pending)
...
//                 // 2) Add Tracking (after processing, before shipped OR if shipped but tracking missing)
...
//                         // allow after processing (and even after shipped) until tracking exists
...
//                 // 3) Mark Order Shipped (only after tracking exists, and order still processing)
...
//                         // This also auto-updates shipment to picked_up internally.
...
//                 // 4) Mark Paid (COD) (visible when COD and payment pending OR failed)
...
//                 // 5) Delivery Failed (shipped + not delivered)
...
//                 // 6) Mark Delivered (Non-COD: always; COD: only after paid)
...
//     /**
//      * Returns: [internalNote, sendToCustomer(bool), noteForEmail]
//      */
...
//     // =============================
//     // (Your existing file below is unchanged)
//     // =============================
